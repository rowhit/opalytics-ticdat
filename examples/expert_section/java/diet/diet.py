...
#
# Note that file requires diet.java to be in the same directory

from ticdat import TicDatFactory, standard_main, java_run
...
def solve(dat):
    ...
    """
    return java_run("diet.java", input_schema, dat, solution_schema)
# ---------------------------------------------------------------------------------
